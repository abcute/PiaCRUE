...
_注：皮亚克鲁是“皮亚杰认知发展理论中的关键概念——最近发展区(Zone of Proximal Development，简称ZPD)——的提出者维果斯基所创的一个术语，也称为‘皮亚杰-维果斯基区域’或‘皮亚杰-维果斯基带’。这个术语描述的是儿童独立解决问题时的实际发展水平(第一个发展水平)和教师指导下解决问题时的潜在发展水平(第二个发展水平)之间的距离。_
